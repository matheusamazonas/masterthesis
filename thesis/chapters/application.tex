The first step to answer the research question was choosing an application to develop. This chapter presents the criteria used in the selection process and the application chosen: home automation.
