...
The \texttt{channelSync} class is responsible for device communication and is implemented by every \gls{mTask} device type. It contains only one function --- also called \texttt{channelSync} --- 
